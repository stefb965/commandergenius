...
public class MainActivity extends Activity
{
    ...
    boolean writeExternalStoragePermissionDialogAnswered = false;

    @Override
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults)
  	{
      Log.i("SDL", "libSDL: onRequestPermissionsResult");
    ...
    protected String getMainSharedObject() {
        String library;
        String[] libraries = MainActivity.mSingleton.getLibraries();
    ...
    protected void onPause() {
        ...
        MainActivity.handleNativeState();
    }
    ...
    public void run() {
      ...
      try
      {
        //if( android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M )
        {
          ...
          PackageInfo info = context.getPackageManager().getPackageInfo(context.getPackageName(), PackageManager.GET_PERMISSIONS | PackageManager.GET_META_DATA);
          Log.v("SDL", "SD card permission 1: " + context.getPackageName() + " perms " + info.requestedPermissions + " name " + info.packageName + " ver " + info.versionName);
          //if( info.requestedPermissions != null && Arrays.asList(info.requestedPermissions).contains(Manifest.permission.WRITE_EXTERNAL_STORAGE) )
          {
            ...
            {
              MainActivity.mSingleton.requestPermissions(new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 0);
            }
          }
        }
      }
        ...
        // Runs SDL_main()
        String library = MainActivity.mSingleton.getMainSharedObject();
        String function = MainActivity.mSingleton.getMainFunction();
        String[] arguments = MainActivity.mSingleton.getArguments();

        Log.v("SDL", "Running main function " + function + " from library " + library);
        MainActivity.nativeRunMain(library, function, arguments);
...
class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        ...
        MainActivity.mNextNativeState = MainActivity.NativeState.PAUSED;
        MainActivity.handleNativeState();
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (event.getSource() == InputDevice.SOURCE_MOUSE && MainActivity.mSeparateMouseAndTouch) {
...
class DummyEdit extends View implements View.OnKeyListener {
    ...
    public boolean onKey(View v, int keyCode, KeyEvent event) {
         ...
         */
        if (event.getAction() == KeyEvent.ACTION_DOWN) {
            if (MainActivity.isTextInputEvent(event)) {
...
class SDLClipboardHandler_API11 implements
    ...
    public void onPrimaryClipChanged() {
        MainActivity.onNativeClipboardChanged();
    }
